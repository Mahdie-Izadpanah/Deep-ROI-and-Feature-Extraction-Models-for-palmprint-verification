...
def main():
    ...
    parser.add_argument('def_path', help='./VGG_CNN_F_deploy.prototxt')
    parser.add_argument('--caffemodel', help='./VGG_CNN_F.caffemodel')
    parser.add_argument('--data-output-path', help='')
    parser.add_argument('--code-output-path', help='./model/')
