...
con = {1: 1, 2: 1, 3: 1, 4: 1, 5: 2, 6: 2, 7: 2, 8:2,9:2,10:2,11:3,12:3,13:3,14:3,15:4}
sc = []
sc1 = []
sc2 = []
...
plt.plot(np.arange(1, 16), sc, linewidth=1.3, antialiased=True)
plt.plot(np.arange(1, 16), sc1, linewidth=1.3, antialiased=True)
plt.plot(np.arange(1, 16), sc2, linewidth=1.3, antialiased=True)
