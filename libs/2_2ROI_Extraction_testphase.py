...
def draw_box(base_dir, name, points):
    ...
    plt.plot([points[0], points[2]], [points[1], points[1]], linewidth=3,c='r')
    plt.plot([points[2], points[2]], [points[1], points[3]], linewidth=3,c='r')
    plt.plot([points[2], points[0]], [points[3], points[3]], linewidth=3,c='r')
    plt.plot([points[0], points[0]], [points[3], points[1]], linewidth=3,c='r')
    plt.show()
